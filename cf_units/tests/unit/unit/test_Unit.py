...
class Test___init__(unittest.TestCase):
    ...
    def test_capitalised_calendar(self):
        calendar = 'GrEgoRian'
        expected = unit.CALENDAR_GREGORIAN
...
class Test_convert__calendar(unittest.TestCase):
    ...
    def test_gregorian_calendar_conversion_setup(self):
        ...
        cal_str = unit.CALENDAR_GREGORIAN
...
class Test_convert__endianness_time(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.time1_unit = unit.Unit('days since 1970-01-01 00:00:00',
                                    calendar=unit.CALENDAR_STANDARD)
        self.time2_unit = unit.Unit('days since 1970-02-01 00:00:00',
                                    calendar=unit.CALENDAR_STANDARD)
...
class Test_convert__endianness_deg_to_rad(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.deg = unit.Unit('degrees')
        self.rad = unit.Unit('radians')
